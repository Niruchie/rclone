...
// TelegramMultipartHasherPartSize is the part size for the TelegramMultipartHash.
var TelegramMultipartHasherPartSize int64 = 0x00020000

// TelegramMultipartHash implements the hash.Hash interface.
